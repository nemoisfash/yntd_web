...
import cn.hxz.webapp.content.entity.FileEntity;
...
public class UploadVideoUtils {
	protected final static Logger logger = LoggerFactory.getLogger(UploadVideoUtils.class);

	TransfMediaUtils transfMediaUtils = new TransfMediaUtils();
    // 文件最大500M
...
//            boolean flag = false;
            if (this.checkAVIType(fileEnd)) {
                ...
                aviPath = transfMediaUtils.processAVI(mencoderPath, filedirs.getAbsolutePath(), codcAviPath);
            ...
            /*if (aviPath != null) {
                ...
                if (this.checkMediaType(fileEnd)) {
                    try {
                        ...
                        transfMediaUtils.processFLV(ffmpegPath, aviPath,    codcFilePath);
